...
- Use descriptive names: `aidlc-docs/{phase-name}-questions.md`
- Examples:
...
## Contradiction and Ambiguity Detection (MANDATORY)
...
1. **Create clarification file**: `aidlc-docs/{phase-name}-clarification-questions.md`
