...
|------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| `common/agent-capabilities.md`                             | Host detection + 3-profile fallback matrix (Claude Code / Kiro IDE / Kiro CLI / Amazon Q IDE / Cursor / Cline / Copilot)                       | [OPTIMIZATION_NOTES §1](OPTIMIZATION_NOTES.md#1-new-commonagent-capabilitiesmd)                                                                           |
